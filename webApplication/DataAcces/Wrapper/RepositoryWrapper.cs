...
namespace DataAcces.Wrapper
{
    public class RepositoryWrapper : IRepositoryWrapper
    {
        ...
        {
            if (_repoContext.Database.CurrentTransaction == null)
                await _repoContext.Database.BeginTransactionAsync();
        }

        public async Task CommitTransactionAsync()
        {
            await _repoContext.Database.CommitTransactionAsync();
        }

        public async Task RollbackTransactionAsync()
        {
            await _repoContext.Database.RollbackTransactionAsync();
        }
    }
}